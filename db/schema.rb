...
ActiveRecord::Schema.define(version: 20_200_813_094_237) do
  ...
  create_table 'character_attributes', force: :cascade do |t|
    ...
    t.index %w[character_type_id name], name: 'index_character_attributes_on_character_type_id_and_name', unique: true
